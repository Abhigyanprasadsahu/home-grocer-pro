...
const Auth = () => {
  ...
  const { user, signUp, signIn, signInWithOtp, signInWithGoogle } = useAuth();
  ...
  const handleOtpSignIn = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!validateEmail(otpEmail)) return;
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-display font-bold text-foreground">Welcome to Flash Cart</h1>
